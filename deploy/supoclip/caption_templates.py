...
CAPTION_TEMPLATES: Dict[str, Dict[str, Any]] = {
    # Primary look: big white + thick black outline (sentence case) — MrBeast-clear style.
    "clear_bold": {
        "name": "Clear Bold",
        "description": "Big white captions with a thick black outline — high contrast, no emoji clutter",
    ...
    "default": {
        "name": "Default",
        "description": "Big white captions with a thick black outline (same as Clear Bold)",
        "font_family": "THEBOLDFONT",
        "font_size": 44,
        "font_color": "#FFFFFF",
        "highlight_color": "#FFFFFF",
